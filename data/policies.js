const policies = [
  {
    ...
    titleQuery: "acceptable-use-policy.hbs",
    desc: "This policy provides guidelines for acceptable use of company-provided devices and networks. It applies to all employees, contractors, and vendors who use company-provided devices or access company networks.",
  },
  {
    id: "2",
    fileName: "Access Control Policy",
    titleQuery: "access-control-policy.hbs",
    desc: "This policy provides guidelines for granting access to company networks and systems. It applies to all employees, contractors, and vendors who use company networks or systems.",
  },
  {
    id: "3",
    fileName: "BYOD Policy",
    titleQuery: "BYOD-policy.hbs",
    desc: "This policy provides guidelines for employees who use their own devices for work purposes. It applies to all employees, contractors, and vendors who use their own devices to access company networks or systems.",
  },
  {
    id: "4",
    fileName: "Data Clarification Policy",
